          ...
          {clicked ? (
            <>
              ...
              <p className="leading-4">
                ...
                suited backend has been used here. Please use <b>jimmi</b> as
                username & <b>jimmi</b> as password. You can find these
              ...
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Your username here... (jimmi)"
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder="Your password here... (jimmi)"
                    className="border w-full border-black py-2 px-8 rounded dark:bg-slate-600"
                  />
