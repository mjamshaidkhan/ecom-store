...
const HeroSection: FC = () => {
  return (
    <div className="bg-epink dark:bg-slate-600 font-lora">
      <div className="container px-4 grid md:grid-cols-2 py-8 mx-auto">
        <div className="flex items-center">
          <div className="max-w-[450px] space-y-4">
            <p className="text-eColor dark:text-white">
              Starting At <span className="font-bold">$999</span>
            </p>
            <h2 className="text-eColor font-bold text-4xl md:text-5xl dark:text-white">
